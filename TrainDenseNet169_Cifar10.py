...
model=Densenet169(num_classes=10).to(device)
model.load_state_dict(torch.load('E:/Project/ModelAndDataset/model/cifar10_denseNet169.pth'))
#损失函数与优化器
...
torch.save(model.state_dict(),"E:/Project/ModelAndDataset/model/cifar10_denseNet169.pth")
