...
class DISCRIMINATOR(nn.Module):
	...
	def save_params(self, modelDir):
		print ('saving params...')
		torch.save(self.state_dict(), join(modelDir,'Discriminator_CelebA.pth'))


	def load_params(self, modelDir):
		print ('loading params...')
		self.load_state_dict(torch.load(join(modelDir,'Discriminator_CelebA.pth')))
...
class CVAE(nn.Module):
	...
	def save_params(self, modelDir):
		print ('saving params...')
		torch.save(self.state_dict(), join(modelDir, 'cVAE_GAN_CelebA.pth'))


	def load_params(self, modelDir):
		print ('loading params...')
		self.load_state_dict(torch.load(join(modelDir, 'cVAE_GAN_CelebA.pth')))
